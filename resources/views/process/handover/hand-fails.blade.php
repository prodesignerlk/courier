...
@section('content')
    ...
    @can('order-deliver-fail.mark')
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header bg-primary text-white action-header">
                        <p>Mark as Failed to Delivery </p>
                    </div>
                    <div class="card-body action-body">
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <select name="" id="reason_id" class="form-control js-example-basic-single">
                                    <option value="" disabled selected>Select Reason</option>
                                    @foreach ($deliver_fail_reason as $reason)
                                        <option value="{{ $reason->deliver_fail_reason_id }}">{{ $reason->reason }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="form-group col-md-4">
                                <button type="submit" class="btn btn-primary btn-block" id="btn-submit">Failed to
                                    Delivery</button>
                            </div>
                        </div>
                    </div>
    ...
    @if ($user->can('order-deliver-fail.search') && $user->can('order-deliver-fail.view'))
        <div class="form-row">
            <div class="col-md-12">
                <div class="card">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-2">
                                ...
                                <select name="" id="staff_id" class="form-control js-example-basic-single">
                                    <option value="" selected>All Riders</option>
    ...
    @can('order-deliver-fail.view')
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header bg-secondary text-white">
                        <p>Failed to delivery packages </p>
                    </div>
                    <div class="card-body">
        ...
        <script>
            ...
            function load_data(from_date, to_date, branch_id, seller_id, staff_id) {
                $('#table-data').DataTable({
                    ...
                    serverSide: true,
                    ajax: {
                        url: '{{ route('hand_deliver_fail_orders_data_table') }}',
                        data: {
                            from_date: from_date,
                            to_date: to_date,
                            branch_id: branch_id,
            ...
            function deliver_fail() {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        notify('success', 'Package Delivery faild');
                        $('#table-data').DataTable().destroy();
                        load_data();

                        setTimeout(function() {
                            $('#btn-submit').html('Failed to Delivery');
                        }, 2000);
