...
@section('content')
    ...
    @if ($user->can('order-receive.search') && $user->can('order-receive.view'))
        <div class="row">
            <div class="col-md-12">
                <div class="card">
        ...
        <script>
            ...
            function load_data(from_date, to_date, branch_id, seller_id) {
                $('#table-data').DataTable({
                    ...
                    serverSide: true,
                    ajax: {
                        url: '{{ route('dis_received_orders_data_table') }}',
                        data: {
                            from_date: from_date,
                            to_date: to_date,
                            branch_id: branch_id,
            ...
            function received() {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        notify('success', 'Package Received.');
                        $('#table-data').DataTable().destroy();
                        load_data();

                        setTimeout(function() {
                            $('#btn-submit').html('Mark as Received');
                        }, 2000);
