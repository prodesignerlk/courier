...
@section('content')
    ...
    @if ($user->can('pickup-collected.search') && $user->can('pickup-collected.view'))
        <div class="form-row">
            <div class="col-md-12">
                <div class="card">
    ...
    @can('pickup-collected.view')
        <div class="row mt-4">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header bg-primary text-white">
                        <p> Pick-ups Collected Orders</p>
                    </div>
                    <div class="card-body">
        ...
        <script>
            ...
            function load_data(from_date, to_date, branch_id, seller_id) {
                $('#table-data').DataTable({
                    ...
                    serverSide: true,
                    ajax: {
                        url: '{{ route('pick_up_collected_orders_data_table') }}',
                        data: {
                            from_date: from_date,
                            to_date: to_date,
                            branch_id: branch_id,
            ...
            function collect() {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        setTimeout(function() {
                            $('#btn-submit').html('Mark as Collect');
                        }, 2000);
